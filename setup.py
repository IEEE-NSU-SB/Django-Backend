...
def create_virtualenv():
    if not Path("venv").exists():
        ...
        return run_command("python3 -m venv venv")
    else:
...
def run_migrations():
    return run_command("python3 manage.py migrate")
...
def load_json_fixture():
    ...
    return run_command(f"python3 manage.py loaddata {fixture_file}")
...
def run_dev_server():
    ...
    return run_command("python3 manage.py runserver")
