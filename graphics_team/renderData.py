...
class GraphicsTeam:
    ...
    def graphics_manage_team_access_modifications(manage_team_access, event_access, graphics_access, graphics_view_access, certificates_access, certificates_view_access, ieee_id):
        try:
            Graphics_Data_Access.objects.filter(ieee_id=ieee_id).update(manage_team_access=manage_team_access, event_access=event_access, graphics_access=graphics_access, graphics_view_access=graphics_view_access, certificates_access=certificates_access, certificates_view_access=certificates_view_access)
            return True
