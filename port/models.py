...
class Chapters_Society_and_Affinity_Groups(models.Model):
    ...
    background_image = ResizedImageField(null=True,blank=True,upload_to="main_website_files/societies_and_ag/background_image/",verbose_name="Background Image")
    mission_description = models.TextField(null=True,blank=True,default="",verbose_name="Mission")
    mission_picture = ResizedImageField(null=True,blank=True,upload_to="main_website_files/societies_and_ag/mission_picture/",verbose_name="Mission Image")
    vision_description = models.TextField(null=True,blank=True,default="",verbose_name="Vission")
    vision_picture = ResizedImageField(null=True,blank=True,upload_to="main_website_files/societies_and_ag/vision_picture/",verbose_name="Vision Image")
